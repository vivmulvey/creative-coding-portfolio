 ...
 * @Last modified time: 2020-11-18T10:36:04+00:00
 */
...
function setup() {
  ...
  for (let y = 0; y < numberOfBigSquares * 2; y++) {
    for (let x = 0; x < numberOfBigSquares * 2; x++) {
      //rotate(90);
      patterns.push(new Pattern(x * squareSize, y * squareSize)); //multiplying the square size by the (x,y) and pushing to the patterns array
    }
  }
}
